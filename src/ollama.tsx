...
const chunkDecoder = (chunk: StreamedChunk, queryType: LlmQueryType) => { 
...
export const Ollama = (
  ...
  return (
  <ModelProvider queryLlm={doQueryLlm} chunkDecoder={chunkDecoder} model={model ?? "llama2"}>
    {children}
  </ModelProvider>
  );
}